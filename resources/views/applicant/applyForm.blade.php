        ...
        <div class="container example z-depth-5">
            <div class="row justify-content-md-center">
                <div class="jumbotron col-md-12"><!-- Nav tabs -->
                    <h1 class="h1 main-title text-center h1-responsive">UNIVERSITY OF TECHNOLOGY, MAURITIUS</h1>
                    <hr>
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group">
                                                <div class="md-form">
                                                    ...
                                                    <small>Attach photocopy of marriage certificate</small>
                                                    <input type="file" id="file" name="marriageUpload">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                                    ...
                                                    {{--<td>--}}
                                                        {{--<div class="md-form">--}}
                                                            {{--<input type="text" id="course3" class="form-control"--}}
                                                                   {{--name="course3">--}}
                                                            {{--<label for="course3">course3 here</label>--}}
                                                        {{--</div>--}}
                                                    {{--</td>--}}
                                                    {{--<td>--}}
                                                        {{--<div class="md-form">--}}
                                                            {{--<input type="text" id="inst3" class="form-control"--}}
                                                                   {{--name="inst3">--}}
                                                            {{--<label for="inst3">inst3 here</label>--}}
                                                        {{--</div>--}}
                                                    {{--</td>--}}
                                                    {{--<td>--}}
                                                        {{--<div class="md-form">--}}
                                                            {{--<input type="text" id="gradee3" class="form-control"--}}
                                                                   {{--name="gradee3">--}}
                                                            {{--<label for="gradee3">gradee3 here</label>--}}
                                                        {{--</div>--}}
                                                    {{--</td>--}}
                                                    {{--<td>--}}
                                                        {{--<div class="md-form">--}}
                                                            {{--<input type="text" id="instDuration3" class="form-control"--}}
                                                                   {{--name="instDuration3">--}}
                                                            {{--<label for="instDuration3">duration3 here</label>--}}
                                                        {{--</div>--}}
                                                    {{--</td>--}}
                                                    {{--<td>--}}
                                                        {{--<div class="form-group">--}}
